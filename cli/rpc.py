...
if __name__ == "__main__":
    ...
    def transfer_(sender_private_key: str, payee_adress: str, amount: int):
        return transfer(
            cli,
            sender=private_key_to_account(sender_private_key),
    ...
    def show_balance(address: str):
        print(get_stc_balance(cli, address=AccountAddress.from_hex(address)))

    Fire(
        {
            'transfer': transfer_,
            'init_legacy': init_legacy_,
            'redeem': redeem_,
        }
    )
